...
if item.uid == 7036 and item.itemid == 426 and getbasin1.itemid == 2229 and getbasin2.itemid == 2229 and getbasin3.itemid == 2229 then
...
elseif item.uid == 7036 and item.itemid == 426 then
doTransformItem(item.uid,item.itemid-1)
else
return 0
end
...
if item.uid == 7036 and item.itemid == 425 then
doTransformItem(item.uid,item.itemid+1)
else
return 0
end
