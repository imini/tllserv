...
function creatureSayCallback(cid, type, msg)
  ...
  local value6 = getPlayerStorageValue(cid,3143)
	...
	elseif value2 == 1 and msgcontains(msg,'lamp') and getPlayerStorageValue(cid,9541) == 8 then 
			...
			elseif getPlayerStorageValue(cid,9541) > 8 and msgcontains(msg,'lamp') then
			...
			doPlayerAddItem(cid,2356,1)
			getPlayerStorageValue(cid,9541,9)

			   selfSay('Finally! I waited for this day. Take lamp and go. Leave now!')
			talk_state = 0
...
function greetCallback(cid)
	if getPlayerStorageValue(cid,9541) > QUEST or getPlayerStorageValue(cid,9543) > QUEST  then
