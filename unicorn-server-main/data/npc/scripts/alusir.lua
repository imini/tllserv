...
function creatureSayCallback(cid, type, msg)
  ...
  msg = string.lower(msg)
	if msgcontains(msg, 'mission') and getPlayerStorageValue(cid,9541) == 4 then
  ...
  elseif msgcontains(msg,'mission') and getPlayerStorageValue(cid,9541) == 6 then
  ...
  talk_state = 0
		...
		elseif talk_state == 1 and msgcontains(msg, 'yes') then
			...
			setPlayerStorageValue(cid,9541,5)
			
		elseif talk_state == 5 and msgcontains(msg, 'yes') then
		if getPlayerItemCount(cid,2346) >= 1 then
     selfSay('So you actually have made it? You have really managed to steal a Tear of Dustwit? ...')
			story = 8
			talk_start = os.clock()
			talk_story = os.clock()
			...
			setPlayerStorageValue(cid,9541,7)
