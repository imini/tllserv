...
function creatureSayCallback(cid, type, msg)
	...
	msg = string.lower(msg)
			...
			if msgcontains(msg, 'djinns') and getPlayerStorageValue(cid,9541) == 2 or
			msgcontains(msg, 'supplies') and getPlayerStorageValue(cid,9541) == 2 then
			...
			setPlayerStorageValue(cid,9541,3)
			talk_state = 0
