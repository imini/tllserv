	...
	if msgcontains(msg, 'weapon') then
		...
		elseif talk_state == 1 then
			...
			doPlayerBuyItem(cid,2570,1,250)
			   npcHandler:say('And here it is, it suits you well!')
			talk_state = 0
			else
...
------------------------------------
		...
		elseif talk_state == 2 then
			...
			doPlayerBuyItem(cid,2148,1,51)
			   npcHandler:say('Thank you very much. I will have a drink or two on your health!')
			talk_state = 0
			else
...
------------------------------------
		...
		elseif talk_state == 3 then
			...
			doPlayerBuyItem(cid,2148,1,201)
			   npcHandler:say('Here you are, I already lessened your load.')
			talk_state = 0
			else
...
------------------------------------
		...
		elseif talk_state == 4 then
			if msgcontains(msg, 'yes') then
			   npcHandler:say('Sorry, you already are a member.')
			talk_state = 0
