...
function creatureSayCallback(cid, type, msg)
  ...
  npcHandler:say('Good! Now bring crude iron.')
  talk_state = 0
  else
  ...
  npcHandler:say('Good! Now bring 50 behemoth fangs.')
  talk_state = 0
  else
  selfSay('No, you no have.')
  talk_state = 0
  ...
  npcHandler:say('Good. Now bring 50 white piece cloth.')
  talk_state = 0
  else
  selfSay('No, you no have.')
  talk_state = 0
  ...
  npcHandler:say('Ah! All stuff there. I will start making axes now. Take my old. I make new for me. And Bron.')
  talk_state = 0
  else
  selfSay('No, you no have.')
  talk_state = 0
