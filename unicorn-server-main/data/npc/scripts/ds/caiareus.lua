...
msg = string.lower(msg)
  ...
  selfSay('GET OUT OF HERE HUMAN SCUM!!') 
		...
		elseif talk_state == 1 and msgcontains(msg, 'yes') then
			   npcHandler:say('Alright then, but you have to swear that you won’t ever set foot in the marids territories.... unless you want to kill them of course. Is that okey?')
			talk_state = 2

		elseif talk_state == 2 and msgcontains(msg, 'yes') then
			   npcHandler:say('Oh. Ok. Welcome then. You may pass... and remember to kill som marids now and then.')
