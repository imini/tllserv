...
function creatureSayCallback(cid, type, msg)
  ...
  msg = string.lower(msg)
	if msgcontains(msg, 'mission') and getPlayerStorageValue(cid,9542) == 7 then
    ...
    selfSay('Well, listen. We are trying to acquire the ultimate weapon to defeat Umar: the Lamp. ...')
		...
		setPlayerStorageValue(cid,9542,8)
    
    elseif getPlayerStorageValue(cid,9542) == 8 and msgcontains(msg,'mission') then
    ...
    talk_state = 0
		...
		if getPlayerStorageValue(cid,9542) == 10 then
    selfSay('Well well, human. So you really have made it – you have smuggled the modified lamp into Umars bedroom! ...')
			...
			setPlayerStorageValue(cid,9542,11)
			talk_state = 0
      else
...
elseif getPlayerStorageValue(cid,9542) == 4 and msgcontains(msg,'mission') then
