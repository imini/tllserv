...
function creatureSayCallback(cid, type, msg)
  ...
  npcHandler:say('Ah, thank you! This potion will certainly serve me well. I want you to bring this little cook book I had in my book case to him. He\'ll like it.')
  talk_state = 0
  else
