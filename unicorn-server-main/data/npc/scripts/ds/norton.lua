...
---------------------------------- bat wing ----------------------------
    ...
    npcHandler:say('Thank you! I really needed them for my anti-wrinkle lotion. Now, please bring me 20 pieces of red cloth.')
		talk_state = 0
		else
...
---------------------------------- red cloth ----------------------------
    ...
    npcHandler:say('Great! This should be enough for my new shirt. Don\'t forget to bring me 100 throwing stars next!')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- throwing star ----------------------------
    ...
    npcHandler:say('Good work. I will need those to cut my cucumber. Next, get me 35 holy orchids.')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- holy orchid ----------------------------
    ...
    npcHandler:say('Thank god! The scent of holy orchids is simply the only possible solution against the horrible stench from the vomit. Now, please bring me 10 rolls of spider silk yarn!')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- spider silk yarn ----------------------------
    ...
    npcHandler:say('I appreciate it. My pet doggie manages to bite through all sorts of leashes, which is why he is always gone. I\'m sure this strong yarn will keep him. Now, go for the 60 green dragon scales!')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- green dragon scale ----------------------------
    ...
    npcHandler:say('Good job. They will look almost like sequins on my new shirt. Please go for the 40 red dragon scales now.')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- red dragon scale ----------------------------
    ...
    npcHandler:say('Thanks! They make a pretty decoration, don\'t you think? Please bring me 15 ounces of magic sulphur now!')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- magic sulphur ----------------------------
    ...
    npcHandler:say('Ah, that\'s enough magic sulphur for my new peeling. You should try it once, your skin gets incredibly smooth. Now, the only thing I need is vampire dust. 30 ounces will suffice.')
		talk_state = 0
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
...
---------------------------------- vampire dust ----------------------------
    ...
    npcHandler:say('Ah, great. Now I can finally finish the potion which the Celerian Academy asked me to. I guess, now you want your reward, don’t you?')
		talk_state = 13
		else
		selfSay('Come back when you got them instead!')
		talk_state = 0
