...
msg = string.lower(msg)
			if msgcontains(msg, 'the fire of the suns') or msgcontains(msg, 'fire of the suns')then
			selfSay('I will enchant you with the fire of the suns for a fee of 10000 gold coins. It will reduce your death penalty by one percent. Are you interested?')
			talk_state = 2
