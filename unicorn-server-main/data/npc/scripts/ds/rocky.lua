...
npcHandler:say('Great! Last but not least, the 50 honeycombs, if you don\'t mind.')
setPlayerStorageValue(cid,9737,-1)
...
npcHandler:say('Alright. Then, as I promised, here is your brand new feather hat. Enjoy it.')
setPlayerStorageValue(cid,9738,-1)
...
npcHandler:say('Ah, my dear mug. Thank you. And in return, here is an old possession of mine which I believe will come in handy sometimes.')
talk_state = 0
else
