...
npcHandler:say('Great! This leather will suffice. Now, please, the 10 bat wings.')
setPlayerStorageValue(cid,9767,-1)
...
npcHandler:say('Fine! These bat wings are ugly enough. Now the last thing: Please bring me 30 heaven blossoms to neutralise the ghoulish stench.')
setPlayerStorageValue(cid,9768,-1)
...
npcHandler:say('This is it! Here you are, a brand old outfit!')
setPlayerStorageValue(cid,9769,-1)
