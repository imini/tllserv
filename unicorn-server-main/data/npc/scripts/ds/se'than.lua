  ...
  sethanvalue2 = getPlayerStorageValue(cid,9458)
    ...
    elseif talk_state == 4 and msgcontains(msg, 'yes') then
			...
			doAddContainerItem(bag,2664,1)
			   npcHandler:say('Nice of you, human. Take this little gift from me instead. Especially the cowl will probably suite you very well. I promise.')
			talk_state = 0
			else
    ...
    talk_state = 4
		...
		elseif talk_state == 1 then
			...
			setPlayerStorageValue(cid,5050,1)
			   npcHandler:say('Thank you! As a reward, I hereby grant you access to the holy chamber of Khamos!')
			talk_state = 0
			else
