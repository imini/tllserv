...
function creatureSayCallback(cid, type, msg)
 ...
 npcHandler:say('Now that you mention it, there\'s something you could do for me. I would of course reward your greatly if you happened to succeed with this, but I have my doubts. It happened a long time ago. Do you want me to tell you about this thing anyway?')
 talk_state = 2
 
 elseif talk_state == 2 and msgcontains(msg,'yes') then
 npcHandler:say('Well, as a visitor of Celeres you might have heard about the dreadful Pire Vam. It is famously known that this ancient ghost had a residence in a manor in the north-west, but noone ever really figured out how to enter it. ...')
 story = 1
 talk_start = os.clock()
 talk_story = os.clock()
 ...
 npcHandler:say('Good. Return to me with the piece of evidence, please.')
 ...
 npcHandler:say('Have you found any evidence that Pire Vam only is a dead man?')
 talk_state = 4
 
 elseif talk_state == 4 and msgcontains(msg,'no') then
 npcHandler:say('Inform me when, or if, you have then.')
 talk_state = 0
 
 elseif talk_state == 4 and msgcontains(msg,'yes') then
 if getPlayerItemCount(cid,7251) >= 1 then
 npcHandler:say('What in the name of Banor? Is that supposed to be the remains of an old man? Maybe I was wrong after all, maybe he wasn\'t just an ordinary man. ...')
 story = 3
 ...
 npcHandler:say('You lack the evidence, I\'m afraid.')
 talk_state = 0
 end
 
 elseif value4 == 1 and msgcontains(msg,'mission') or
 value4 == 1 and msgcontains(msg,'evidence') then
 npcHandler:say('I was wrong, I have admitted it. We must now both remember not to tell anyone about this.')
 talk_state = 4
 ...
 npcHandler:say('So receive my prayer: \'Hope shall fill your heart - doubt shall be banned\'. Now, bring your stake to Flynn in Adanac for the next line of the prayer. I will inform him what to do.')
 ...
 npcHandler:say('I told you to continue to Flynn in Adanac for the next line of prayer.')
 talk_state = 0
	end
	return true
end
