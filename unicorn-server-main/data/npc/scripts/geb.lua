...
--Statues:
shopModule:addBuyableItem({'knight statue', 'knight statue'},    2471, 50,	 1,	'knight statue')
--shopModule:addBuyableItem({'minotaur statue', 'minotaur statue'},	2471,	50,	1,	'minotaur statue')
--shopModule:addBuyableItem({'goblin statue', 'goblin statue'},    2471, 50, 	1	'goblin statue')
--Tables:
