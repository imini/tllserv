...
function creatureSayCallback(cid, type, msg)
  ...
  msg = string.lower(msg)
			...
			if msgcontains(msg, 'mission') and value2 == -1 then
			   selfSay('Yes! You must help me! My brother has been caught by the perilous black knights. I don’t even know if he’s alive still, buy please – find out for me. Go down there and look for the black knights – and my brother. Could you do that?')
			talk_state = 2
