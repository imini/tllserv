...
selfSay('Excellent. Not only did you provide me with something I needed, but you also proved that you are reliable. We can discuss missions when you feel like it.')
talk_state = 0
else
selfSay('You haven\'t.')
talk_state = 0
...
selfSay('Ah, you really did it. Now, we must continue quickly with the next part. Here, take this royal brooch again. Go stand on one of the benches outside the depot and then slip it down behind them. Quickly!')
talk_state = 0
else
talk_state = 0
selfSay('Lies, lies.')
