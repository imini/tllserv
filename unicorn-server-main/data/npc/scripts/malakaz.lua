    ...
    selfSay('You have humour, human.')
		...
		elseif talk_state == 1 then
			if msgcontains(msg, 'yes') then
			   selfSay('A human who knows jokes? Yeah, right... I’ll tell you a real joke, little filth. Once there was 2 little small minotaurs. They were both... oh, you knew that one already? ...')
				story = 1
				talk_start = os.clock()
				talk_story = os.clock()
