...
function creatureSayCallback(cid, type, msg)
 ...
 selfSay('So, prayer... blabla, nonsense. Here you go. As you see, my magical powers are unlimited.')
 doPlayerRemoveItem(cid,5941,1)
 doPlayerAddItem(cid,5942,1)
 talk_state = 0
 else
 selfSay('I cannot produce a blessed wooden stake from thin air. Bring a stake, fool.')
 talk_state = 0
 end

 elseif value7 == -1 and msgcontains(msg,'wand of vortex') and voc == 1 then
 selfSay('Well, you\'re a sorcerer, and that means you may have a wand of vortex for free. Do you want it now?')
 talk_state = 8
 
 elseif talk_state == 8 and msgcontains(msg,'no') then
 selfSay('Now you know the offer at least.')
 talk_state = 0
 ...
 elseif value7 == 1 and msgcontains(msg,'wand of vortex') and voc == 1 then
 selfSay('You have already been given a free wand of vortex, would you like to pay 500 gold coins for another?')
 talk_state = 9
 ...
 selfSay('You do not have enough money, ' .. getPlayerName(cid) .. '.')
 talk_state = 0
 end
 
 elseif value7 == -1 and msgcontains(msg,'snakebite rod') and voc == 2 then
 selfSay('Well, you\'re a druid, and that means you may have a snakebite for free. Do you want it now?')
 talk_state = 10
 ...
 elseif value7 == 1 and msgcontains(msg,'snakebite rod') and voc == 2 then
 selfSay('You have already been given a free snakebite rod, would you like to pay 500 gold coins for another?')
 talk_state = 11
 ...
 selfSay('Would you like to buy a snakebite rod for 500 gold coins?')
 talk_state = 12
 ...
 selfSay('Would you like to buy a wand of vortex for 500 gold coins?')
 talk_state = 15
