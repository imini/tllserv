...
selfSay('Thank you. They are perfect. Perhaps, together with a plate, I could actually eat them properly.')
talk_state = 0
...
selfSay('Terrific. I like that. You know what?')
talk_state = 41
setPlayerStorageValue(cid,9544,8)
else
talk_state = 0
...
selfSay('Thanks. Now I can eat. I can give you something awesome if you bring me a life crystal.')
talk_state = 0
...
selfSay('Thanks. You can have the life ring back, since I mistakly confused it with a ring of healing.')
talk_state = 0
...
doPlayerRemoveItem(cid,2177,1)
doPlayerAddItem(cid,2168,20)
selfSay('Thanks. Here is another one of those stupid life rings.')
talk_state = 0
...
doPlayerRemoveItem(cid,2177,1)
doPlayerAddItem(cid,2168,20)
selfSay('Thanks. I have many rings, just keep on trading.')
talk_state = 0
...
doPlayerRemoveItem(cid,2177,1)
doPlayerAddItem(cid,2168,20)
selfSay('Thanks. Here is another life ring.')
talk_state = 0
else
talk_state = 0
selfSay('I think you dropped the life ring.')
