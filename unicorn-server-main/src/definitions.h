...
static constexpr auto STATUS_SERVER_NAME = "The Lost Lands";
static constexpr auto STATUS_SERVER_VERSION = "0.1 Tll";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Steven.P";
